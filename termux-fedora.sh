...
case "$1" in
	f40_arm64)
	    DOCKERIMAGE=https://mirror.yer.az/fedora/releases/40/Container/aarch64/images/Fedora-Container-Base-Generic.aarch64-40-1.14.oci.tar.xz
	    ;;
	f39_arm64)
	    DOCKERIMAGE=https://mirror.yer.az/fedora/releases/39/Container/aarch64/images/Fedora-Container-Base-39-1.5.aarch64.tar.xz
	    ;;
	uninstall)
	    chmod -R 777 ~/fedora
	    rm -rf ~/fedora
	    ...
	    ;;
	*)
	    echo $"Usage: $0 {f39_arm64|f40_arm64|uninstall}"
	    exit 2
	    ;;
esac
